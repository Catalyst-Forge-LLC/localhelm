...
Usage:
  ...
  localhelm serve [--host ADDR] [--port N] [--free-port] [--demo]
                                 default 0.0.0.0 (all interfaces). --demo is a sandbox fleet.
