...
**Stations + body (2026-09-15):** Operator asked to go brighter and carry the HUD to tabs / boards / tables. Chart grid stays on the bridge; the tab rail and workspace sit on solid `--hull` so stations read on a darker band. Stations are tracked uppercase with a cyan active underline. Panels get corner ticks; writes stay gold.  
