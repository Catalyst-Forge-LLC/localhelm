...
`git status` in a folder answers that folder. After a morning of publishes, the question is which products are dirty, which versions never made it to npm, and which dependents still pin last week’s package.
