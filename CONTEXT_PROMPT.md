...
- Public slogan is **Control panel for local development** (d62). Shipping-only “status for the products you ship” dropped — the board includes local tools that never publish. Public copy links [LocalSlip](https://localslip.dev); footer has the same link. aiBreze pass 2026-08-28: you-voice, pairing once per page, no shop ids in examples.
