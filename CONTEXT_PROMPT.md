...
- Bridge lockup is stacked **local** / **HELM**. Narrow widths fold Refresh, Pull, Push, Activity, and gauges into the locker so the header does not collide (d143). Keel (remotes / npm) is a top well plate above lamps + gauges, same bottom rounding as body panels.
