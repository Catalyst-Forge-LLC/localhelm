...
- Ports: Leases / Stacks / Observed. Lease filters copy LocalBerth (Listening/Quiet, LAN/Loopback, Conflict/Ephemeral, firewall). Observed only gets Bind. `?ports=stacks` or `observed`.
