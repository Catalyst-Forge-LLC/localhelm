...
localhelm publish ollanet --apply       # waits in this terminal if npm asks to press Enter / open a browser
localhelm publish ollanet --apply --otp 123456   # only if npm asks for an authenticator code
